...
<script>
//添加车间
var addUrl=path+"workshop/add";
//编辑车间
var editUrl=path+"workshop/edit";
//删除车间
var deleteUrl=path+"workshop/delete";

var dialogWidth=450,dialogHeight=240;

//查询
function filter() {
	EasyUI.grid.search("dg","workshopSearchForm");
}
...
var add = function() {
	var wid = Dialog.open("添加", dialogWidth, dialogHeight,addUrl, [
		...
		EasyUI.form.submit("workshopForm",addUrl, function(data){
			filter();
...
var edit = function(){
	...
	var wid = Dialog.open("编辑", dialogWidth, dialogHeight, editUrl+"?id="+r.ID, [ 
	    EasyUI.window.button("icon-save", "保存", function() {
		EasyUI.form.submit("workshopForm", editUrl, function(data) {
			filter();
			Dialog.close(wid);
		})
	}), EasyUI.window.button("icon-cancel", "关闭", function() {
