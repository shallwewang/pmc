	...
	<div data-options="region:'center',border:false" style="overflow: auto;position: relative; height: 140px; width: 925px">
		<div id="toolbar">
			...
			<div style="border-top:1px solid #DDDDDD">
				<form action="#" id="sPSResetSearchForm">
		...
		<table id="dg" singleSelect="false" title="大循环校验信息列表" class="easyui-datagrid"  url="${path}sPSReset/list" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true">
			<thead>
				<tr>
					<th field="ID" checkbox=true ></th>
					<th field="PLANTNO" width="15">工厂</th>
					<th field="SHEETNO" width="15">物料单号</th>
					<th field="VIN" width="15">VIN号</th>
					<th field="SHIPTIME" width="15">拣配时间</th>
				</tr>
			</thead>
		</table>
	</div>
